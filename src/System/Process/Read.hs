...
module System.Process.Read
  ...
  ,HasEnvOverride (..)
  ,workingDirL
  ,withProc -- FIXME document
  ,withEnvOverride -- FIXME document
  ,withModifyEnvOverride -- FIXME document
  ,withWorkingDir -- FIXME document
  ,runProcess
  ,runProcess_
  ,runEnvNoLogging
  )
...
withEnvOverride = local . set envOverrideL
